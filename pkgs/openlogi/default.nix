...
let
  ...
  sources = {
    x86_64-linux = {
      asset = "openlogi-v0.6.27-linux-amd64.deb";
      hash = "sha256-9O1Fwc7RGpiwWeysNQHEu4+rGJqtMmqhWe9AhEnkLbs=";
    };

    aarch64-linux = {
      asset = "openlogi-v0.6.27-linux-arm64.deb";
      hash = "sha256-V4Q13xpEzZ1BAf3bt14sykq1moEXxMdwW1rPyqYsUyI=";
    };
  };
