...
let
  ...
  sources = {
    x86_64-linux = {
      asset = "openlogi-v0.6.22-linux-amd64.deb";
      hash = "sha256-LDzpb5jy5pbDVlgUcu770+Fxy7G/gLS1eCwFhuCdzQA=";
    };

    aarch64-linux = {
      asset = "openlogi-v0.6.22-linux-arm64.deb";
      hash = "sha256-SEt2c+d6gOX7gaV7n0o43Aldeg4Xg29GAXtXyL+7IMU=";
    };
  };
